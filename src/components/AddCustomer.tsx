...
function AddCustomer() {
    ...
    const pushDB = () => {
        push(dbRef(db, 'Customer/'), customer);
                ...
                <div className="mx-3">
                    ...
                    <div className="grid gap-4 grid-cols-2">                     
                        <div className="block">
                            ...
                            <input onChange={event => setTenkh(event.target.value)} className="focus: text-size-xl leading-5.6 ease-soft block w-96 border border-solid border-gray-300 bg-white bg-clip-padding px-3 py-2 mb-2  font-normal text-gray-700 transition-all focus:border-sky-600 focus:transition-shadow" placeholder="Nhập họ tên" name="description"></input>
                        </div>
                        <div className="block">
                        ...
                        <div className="block">
                            ...
                            <input onChange={event => setNgaysinh(event.target.value)} type="text" className="ifocus: text-size-xl leading-5.6 ease-soft block w-96 border border-solid border-gray-300 bg-white bg-clip-padding px-3 py-2 mb-2  font-normal text-gray-700 transition-all focus:border-sky-600 focus:transition-shadow" placeholder="Nhập ngày sinh" ></input>
                        </div>            
                    </div>
            </div>
            {/*footer*/}
